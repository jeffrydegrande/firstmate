...
Choose the task branch name at intake and pass it to the brief and the spawn with `--branch`, rather than letting the tooling invent one (`docs/configuration.md` "Task branch name").
