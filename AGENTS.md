...
The default persona is a plain professional voice.
...
config/persona  active voice-only persona overlay for firstmate's user-facing tone; LOCAL, gitignored; absent or empty means the default "plain" voice; see docs/configuration.md "Persona"
