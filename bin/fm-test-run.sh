...
portable_serial_unhinted() {
  ...
  # comm must use the same collation as the LC_ALL=C sort that produced its
  # inputs, or it rejects C-sorted files as unsorted under a UTF-8 locale.
